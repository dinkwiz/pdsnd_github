...
def get_filters():
    ...
    city = input("Which city would you like to explore? Chicago, New York City, Washington? Please input city name: ").lower()

    while city not in ['chicago', 'new york city', 'washington']:
        city = input(
        "I don\'t recognise this city. Please try again: ").lower()

    # get user input for month (all, january, february, ... , june)
    month = input("Which month would you like to explore? All, January, February, March, April, May or June? Please input month name: ").lower()

    # get user input for day of week (all, monday, tuesday, ... sunday)
    day = input("Which day would you like to explore? Please input day of week or all: ").lower()
...
def display_data(df):
    ...
    display_active = input("Do you want to see the raw data? Enter Yes or No: ").lower()
